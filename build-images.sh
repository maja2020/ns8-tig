...
buildah config --entrypoint=/ \
    ...
    --label="org.nethserver.images=docker.io/influxdb:3.8-core docker.io/telegraf:1.37-alpine docker.io/grafana/grafana:12.4.0-20733476222 docker.io/influxdata/influxdb3-ui:1.6.0" \
    "${container}"
# Commit the image
